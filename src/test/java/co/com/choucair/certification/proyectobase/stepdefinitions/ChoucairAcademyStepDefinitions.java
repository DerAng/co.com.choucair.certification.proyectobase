...
public class ChoucairAcademyStepDefinitions {
    ...
    public void sheSearchForTheCourseFoundationLevelOnTheChoucairAcademyPlatform(List<AcademyChoucairData> academyChoucairData) throws Exception {

        OnStage.theActorInTheSpotlight().attemptsTo(Search.the(academyChoucairData.get(0).getStrCourse()));
    }

    @Then("^she finds the course called$")
    public void sheFindsTheCourseCalledFoundationLevel(List<AcademyChoucairData> academyChoucairData) throws Exception {
